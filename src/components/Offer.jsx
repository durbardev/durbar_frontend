...
function Offer() {
    return (
        ...
        >
            <span
                className="pointer-events-none absolute -top-10 right-0 text-[180px] leading-none font-bold tracking-[-0.08em] text-black/[0.08] uppercase sm:text-[300px] lg:text-[430px]"
                aria-hidden="true"
            >
                Offer
            </span>
            ...
            <div className="relative mx-auto max-w-[1320px]">
                <header className="mb-12 max-w-[790px]">
                ...
                <div className="grid gap-5 lg:grid-cols-[0.82fr_1.18fr]">
                    <div className="relative z-10 flex flex-col bg-white p-7 text-black shadow-[0_25px_70px_rgba(70,0,0,0.25)] sm:p-10 lg:p-12">
                        ...
                        <ul className="mt-7 grid gap-4">
                            {features.map((feature) => (
                                <li className="flex items-center gap-3 text-sm font-medium text-black/65" key={feature}>
                        ...
                        <PrimaryButton className="mt-9 gap-3 self-start px-7" href="#contact">
                            Claim this offer
                            <ArrowRight className="size-4" aria-hidden="true" />
                        </PrimaryButton>
                    </div>

                    <div className="relative min-h-[390px] overflow-hidden border border-white/20 bg-[#090909] shadow-[0_25px_70px_rgba(70,0,0,0.25)] lg:min-h-[600px]">
                        <img
